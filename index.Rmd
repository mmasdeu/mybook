...
output:
  bookdown::pdf_book:
    ...
    toc: yes
    microtypeoptions: verbose=silent
  bookdown::gitbook:
    split_by: chapter
    config:
        toolbar:
...
El curs es pot dividir de manera natural en 15 sessions de dues hores. El temps efectiu de cadascuna d'aquestes sessions és de 100 minuts, i hem pensat que us pot pensar com una sèrie de 15 capítols. Seguidament detallem cadascun d'aquests capítols i la seva sinopsi.
