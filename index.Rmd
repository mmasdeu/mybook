...
bibtlatexoptions: [style=alphabetic,citestyle=alpha,sorting=nyt,sortcites=true,autopunct=true,autolang=hyphen,hyperref=true,abbreviate=true,backref=true,backend=biblatex,defernumbers=true]
link-citations: yes
