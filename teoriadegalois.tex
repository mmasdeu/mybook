...
L'estructura que s'ha seguit és essencialment la de Dummit and Foote (\protect\hyperlink{ref-dummitfoote}{2004}), però la demostració del teorema fonamental s'ha fet completament diferent,
seguint un punt de vista proposat per Geck (\protect\hyperlink{ref-geck}{2014}). També s'ha canviat la presentació de l'existència de la clausura algebraica d'un cos arbitrari.
...
irreductible de grau \(n\) (Teorema \ref{prp:existencia-polis-irred-Fp})
\end{example}
...
obtenir aplicant proporcionalitat, com aquí sota.
...
Demostreu que el costat \(AG\) del dibuix de sota mesura \(\sqrt[3]{2}\).
...
També veurem les clausures algebraiques, i una construcció (seguint Artin (\protect\hyperlink{ref-artinalgebra}{2014}) i Jelonek (\protect\hyperlink{ref-zbigniew}{1993})). Això ens permetrà (assumint el teorema fonamental
...
irreductible. Això ho veurem més endavant, al Teorema \ref{thm:existencia-polis-irred-Fp}.
...
\chapter{La clausura algebraica}\label{la-clausura-algebraica}}
...
\hypertarget{la-clausura-algebraica-1}{%
\section{La clausura algebraica}\label{la-clausura-algebraica-1}}
...
Considerem en aquest cas l'extensió \(\Fpbar / \FF_p\), on \(\Fpbar = \bigcup_{n\geq 1} \FF_{p^n}\). Tenim un morfisme injectiu
\[
...
Artin, Michael. 2014. \emph{Algebra / Michael Artin.} 2nd ed., new international ed. Edinbourgh Gate, Harlow, Essex: Pearson.

\leavevmode\vadjust pre{\hypertarget{ref-dummitfoote}{}}%
Dummit, David S., and Richard M. Foote. 2004. \emph{Abstract Algebra}. 3rd ed. New York: Wiley.

\leavevmode\vadjust pre{\hypertarget{ref-geck}{}}%
Geck, Meinolf. 2014. {``On the Characterization of {G}alois Extensions.''} \emph{Amer. Math. Monthly} 121 (7): 637--39. \url{https://doi.org/10.4169/amer.math.monthly.121.07.637}.

\leavevmode\vadjust pre{\hypertarget{ref-zbigniew}{}}%
Jelonek, Zbigniew. 1993. {``A Simple Proof of the Existence of the Algebraic Closure of a Field.''} \emph{Univ. Iagel. Acta Math.}, no. 30: 131--32.

\leavevmode\vadjust pre{\hypertarget{ref-rotman}{}}%
Rotman, Joseph J. 2015. \emph{Advanced Modern Algebra. {P}art 1}. Third. Vol. 165. Graduate Studies in Mathematics. American Mathematical Society, Providence, RI. \url{https://doi.org/10.1090/gsm/165}.

\leavevmode\vadjust pre{\hypertarget{ref-weintraub}{}}%
Weintraub, Steven H. 2021. {``The Theorem of the Primitive Element.''} \emph{Amer. Math. Monthly} 128 (8): 753--54. \url{https://doi.org/10.1080/00029890.2021.1944757}.
