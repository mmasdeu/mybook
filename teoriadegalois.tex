...
\caption{Multiplicació i divisió amb regle i compàs.}\label{fig:unnamed-chunk-1}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth,]{teoriadegalois_files/figure-latex/unnamed-chunk-2-1} 

}

\caption{Construcció de l'arrel quadrada amb regle i compàs}\label{fig:unnamed-chunk-2}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth,]{images/pentagon} 

}

\caption{Construcció d'un pentàgon regular amb regle i compàs.}\label{fig:unnamed-chunk-3}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth,]{images/triseccio_angle} 

}

\caption{Trissecció d'un angle amb regle marcat i compàs.}\label{fig:unnamed-chunk-4}
\end{figure}
...
{\centering \includegraphics[width=0.5\linewidth,]{images/duplicacio_cub} 

}

\caption{Duplicació del cub amb regle marcat i compàs.}\label{fig:unnamed-chunk-5}
\end{figure}
...
\begin{proposition}
\protect\hypertarget{prp:preliminar}{}\label{prp:preliminar}Sigui \(K\) un cos qualsevol. Sigui \(H\leq\Aut(K)\) un subgrup finit, i sigui \(F=K^H\). Aleshores \(K\) és Galois sobre \(F\),
i \(\Gal(K/F) = H\).
\end{proposition}
...
\begin{proposition}
\protect\hypertarget{prp:galois-subext}{}\label{prp:galois-subext}Sigui \(K/F\) finita Galois, i sigui \(M\) una subextensió. Aleshores \(K/M\) és Galois.
\end{proposition}
...
\tightlist
\item
  \(K^{\Gal(K/M)} \stackrel{?}{=} M\). Sigui \(H=\Gal(K/M)\). És obvi que \(M \subseteq K^H\). D'altra banda, la Proposició
...
{\centering \includegraphics[width=1\linewidth,]{teoriadegalois_files/figure-latex/unnamed-chunk-6-1} 

}

\caption{Reticle de subgrups del grup quasidiedral.}\label{fig:unnamed-chunk-6}
\end{figure}
