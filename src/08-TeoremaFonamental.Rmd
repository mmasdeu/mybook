...
1. $K^{\Gal(K/M)}= M$. Això és automàtic a partir de la Proposició \@ref(prp:preliminar) i del Corol·lari \@ref(cor:fix-gal-eq).
...
```{tikz, echo=FALSE, out.width='100%', fig.ext='png', fig.align='center', cache=TRUE, engine.opts = list(background = 'transparent')}
