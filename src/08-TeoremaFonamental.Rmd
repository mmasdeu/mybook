...
::: {.proof}
Hem de veure:
1. $K^{\Gal(K/M)}= M$. Això és automàtic a partir de la proposició i del Corol·lari @ref(fix-gal-eq).
...
que $K=\bigcup_{\sigma\in H} \Eq(\sigma,\tau)$. Pel Lema @ref(lema-algebra-lineal), algun dels $\Eq(\sigma,\tau)$
...
o el cos de descomposició de $\QQ(\sqrt[8]{2}, \zeta_8)$ de $\sqrt[8]{2}$. És important adonar-se que no n'hi ha prou en assignar valors
