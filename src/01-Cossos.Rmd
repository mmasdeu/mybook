...
conjunt finit format per $\alpha_1,\ldots,\alpha_n$ aleshores escriurem $F(\alpha_1,\ldots,\alpha_n)$ i direm que $F(S)$ és *finitament generada*. Un cas particular
...
::: {.theorem #extensio-isos name="extensió d'isomorfismes"}
