...
$$
M_{i,j} = \{x \in K ~|~ \sigma_i(x)=\sigma_j(x)\}.
$$
És fàcil veure que $M_{i,j}\subsetneq K$ i que $M_{i,j}$ és un cos. Aplicant la proposició anterior,
hi ha algun $\alpha\in K$ que no està en cap dels $M_{i,j}$. El polinomi mínim d'$\alpha$ sobre $F$
