...
```{r, echo=FALSE, out.width="60%", fig.align='center', fig.cap="Multiplicació i divisió."}
...
```{tikz, echo=FALSE, out.width='50%', fig.ext='png', fig.align='center', engine.opts = list(background = 'transparent')}
